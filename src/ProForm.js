...
const ProForm = ({ steps, onBackClick, onNextClick }) => {
  ...
  return (
    <form class="proform" onSubmit={handleSubmit}>
      ...
      <h3>Tracking Method:</h3>
        ...
        <div>
          <input
            ...
            name="tracking"
            value="any tracking"
            checked={tracking === "any tracking"}
            onChange={(e) => setTracking(e.target.value)}
          />
          <label htmlFor="any tracking">Any</label> 
        </div>
      </label>
        <div class="bottom">
